...
bool instr_modrm(Dinstruction* decoded, unsigned char opcode){
    if(decoded->status.extended){
        switch(opcode){
            ...
            case 0x7D: case 0x7E: case 0x7F: case 0x90: case 0x91:
            ...
            case 0xA4: case 0xA5: case 0xAB: case 0xAC: case 0xAD:
            ...
            case 0xC7: case 0xD0: case 0xD1: case 0xD2: case 0xD3:
...
bool instr_zero(Dinstruction* decoded, unsigned char opcode){
    if(decoded->status.extended){
        switch(opcode){
            ...
            case 0x34: case 0x35: case 0x37: case 0x77: case 0xA0:
            case 0xA1: case 0xA2: case 0xA8: case 0xA9: case 0xAA:
            case 0xC8: case 0xC9: case 0xCA: case 0xCB: case 0xCC:
...
bool instr_has_immediate_operand(Dinstruction* decoded, unsigned char opcode){
    if(decoded->status.extended){
        switch(opcode){
            ...
            case 0x70: case 0x71: case 0x72: case 0x73: case 0xA4:
            case 0xAC: case 0xBA: case 0xC2: case 0xC4: case 0xC5:
            case 0xC6:
                return true;
            default:
                return false;
...
size_t get_opcode_extension_operand_size(Dinstruction* decoded, unsigned char opcode){
	switch(opcode){
		case 0xF6:
			if(decoded->modrm.reg == 0x00) { return BYTE_SZ; }
		case 0xF7:
			if(decoded->modrm.reg == 0x00) { return DOUBLEWORD_SZ; }
	}
	return 0x00;
}
...
size_t get_operand_size32(Dinstruction* decoded, unsigned char opcode){
    if(decoded->status.extended){
        switch(opcode){
            ...
            case 0x73: case 0xA4: case 0xAC: case 0xBA: case 0xC2:
    ...
    switch(opcode){
        ...
        case 0xC1: case 0xC6: case 0xD0: case 0xD1: case 0xD2: 
        case 0xD3: case 0x70: case 0x71: case 0x72: case 0xEB:
        ...
        case 0x2D: case 0x35: case 0x3D: case 0x68: case 0xA0:
        case 0xA1: case 0xA2: case 0xA3: case 0xA9: case 0xB8: 
        case 0xB9: case 0xBA: case 0xBB: case 0xBC: case 0xBD: 
        case 0xBE: case 0xBF: case 0x69: case 0x81: case 0xC7: 
        case 0xE8: case 0xE9:
...
size_t get_operand_size64(Dinstruction* decoded, unsigned char opcode){
    ...
    switch(opcode){
        ...
        case 0x05: case 0x0D: case 0x15: case 0x1D: case 0x25:
        case 0x2D: case 0x35: case 0x3D: case 0x68: case 0xA9: 
