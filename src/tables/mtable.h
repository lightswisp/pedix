...
const char *extd_ext_11b_66[0x100][0x08] = {
...
const char *extd_ext_mem_66[0x100][0x08] = {
    [0xC7] = {"", "", "", "", "", "", "vmclear"}};

const char *extd_ext_mem_f3[0x100][0x08] = {
    [0xC7] = {"", "", "", "", "", "", "vmxon"}};

const char *extd_ext_mem[0x100][0x08] = {
    [0x00] = {"sldt", "str", "lldt", "ltr", "verr", "verw"},
...
const char *extd[0x100] = { // 0x0f
    "",     "",       "lar",  "lsl",    "", "syscall",
    "clts", "sysret", "invd", "wbindv", "", "ud2"};

const char *reg_ext_11b[0x100][0x08] = {
...
const char *reg_ext_mem[0x100][0x08] = {
    [0x80] = {"add", "or", "adc", "sbb", "and", "sub", "xor", "cmp"},
    [0x81] = {"add", "or", "adc", "sbb", "and", "sub", "xor", "cmp"},
    [0x82] = {"add", "or", "adc", "sbb", "and", "sub", "xor", "cmp"},
    [0x83] = {"add", "or", "adc", "sbb", "and", "sub", "xor", "cmp"},
...
const char *m_ex_table[0x100][0x08] = {
    [0x80] = {"add", "or", "adc", "sbb", "and", "sub", "xor", "cmp"},
    [0x81] = {"add", "or", "adc", "sbb", "and", "sub", "xor", "cmp"},
    [0x82] = {"add", "or", "adc", "sbb", "and", "sub", "xor", "cmp"},
    [0x83] = {"add", "or", "adc", "sbb", "and", "sub", "xor", "cmp"},
...
const char *m_extd_ex_table[0x100][0x08] = {
    [0x00] = {"sldt", "str", "lldt", "ltr", "verr", "verw", "", ""},
