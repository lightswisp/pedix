...
/* 32-bit registers */
const char *modrm_reg32[] = {"eax", "ecx", "edx", "ebx",
                              "esp", "ebp", "esi", "edi"};
/* 64-bit registers */
const char *modrm_reg64[] = {"rax", "rcx", "rdx", "rbx",
                              "rsp", "rbp", "rsi", "rdi"};

/* instr_zero with 32-bit operands map */ 
const char *z_instr_op32[] = {[0x06] = "es",
                               [0x07] = "es",
                               [0x0e] = "cs",
                               [0x16] = "ss",
                               [0x17] = "ss",
...
const char *z_instr_op16[] = {[0x06] = "es",
                               [0x07] = "es",
                               [0x0e] = "cs",
                               [0x16] = "ss",
                               [0x17] = "ss",
...
const char *o_instr_op32[] = {[0x04] = "al," OPERAND_BYTE,
...
const char *o_instr_op16[] = {[0x04] = "al," OPERAND_BYTE,
